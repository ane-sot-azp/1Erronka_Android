        ...
        listenJob =
            viewModelScope.launch(Dispatchers.IO) {
                try {
                    ...
                    val connectedSocket = s ?: throw (lastConnectError ?: IllegalStateException("No se pudo conectar"))
                    if (!connectedSocket.isConnected) {
                        throw (lastConnectError ?: IllegalStateException("No se pudo conectar"))
                    }
                    ...
                    withContext(Dispatchers.Main) {
                        _uiState.update { it.copy(status = "Enviando usuario") }
                    }
